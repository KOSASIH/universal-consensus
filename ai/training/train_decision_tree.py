...
def main():
    ...
    # Create train decision tree object
    tdt = TrainDecisionTree(X_train, y_train, X_test, y_test)

    # Handle imbalanced data
    X_train_res, y_train_res = tdt.handle_imbalanced_data()
    tdt.X_train = X_train_res
    tdt.y_train = y_train_res
    ...
    tdt.tune_hyperparameters()

    # Random search
    tdt.random_search()

    # Cross validation
    tdt.cross_validation()
